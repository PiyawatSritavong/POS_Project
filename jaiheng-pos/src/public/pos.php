        ...
        <div class="col ">
        	<div class="input-group mb-2 " style="height30px;  ">
				<span class="input-group-text" id="basic-addon1"><i class="fa fa-search"></i></span>
					...
					<div class="table-responsive" style="height: 500px;px;overflow-y: scroll;">
						<table class="table table-striped table-hover">
						<tr>
							<th>สินค้าทั้งหมด&nbsp;&nbsp; ( <span > 0 </span> ) </span> </th>
						</tr>
				...
				<div onclick="add_item(event)" class="js-products d-flex" style="flex-wrap: wrap;;overflow-y: scroll;"> </div>
