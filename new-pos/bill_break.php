...
if (!empty($_GET["action"])) {
    switch ($_GET["action"]) {
        ...
        case "empty":
            ...
            set_url("http://localhost/pos/new-pos/bill_break.php");
            break;
        case "database":
?>
    ...
    ?>
            <div class='col profile'>
                <div class='card bg-second btn-zoom'>
                    <form method="post" action="bill_break.php?action=add&pd_id=<?php echo $product_array[$key]["pd_id"]; ?>">
                        <div class='card-body'>
    ...
    <div class="card-body">
        ...
        ?>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="bill_break.php?action=remove&pd_id=<?php echo $item["pd_id"]; ?>" class="link-danger">
            ...
            <div class="card-footer mb-5 pb-4 pe-5 me-5 ps-0 ms-0">
                <form method="post" class="text-end d-flex" action="bill_break.php">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <button type="button" name="discount_input" class="btn btn-outline-green text-white border border-light w-50 p-0" data-bs-toggle="modal" data-bs-target="#change">เพิ่มเติม</button>
                                    <!-- <input type="button" value="เพิ่มเติม" data-bs-toggle="ChangeModal" data-bs-target="#change" class="btn btn-outline-green text-white border border-light w-25" /> -->
                                </td>
                            </tr>
                            <tr>
                                <td class="text-start">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="change" tabindex="-1" aria-labelledby="ChangeModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content bg-second text-white r-2">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-3" id="ChangeModalLabel">ส่วนลด</h1>
                                    <button type="button" class="btn btn-light btn-close" data-bs-dismiss="ChangeModal" aria-label="Close"></button>
                                </div>
                ...
                <div class="w-100 d-flex py-2">
                    <a id="btnEmpty" href="bill_break.php?action=empty" class="text-white text-decoration-none w-100 me-1">
                ...
                <button type="button" class="btn btn-danger w-100" data-bs-toggle="modal" data-bs-target="#exampleModal">จ่ายเงิน</button>
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content bg-second text-white r-2">
                            ...
                            <form method="post" action="bill_break.php?action=database">
                                <div class="modal-footer">
                ...
                <table class="table table-borderless text-white">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" action="bill_break.php?action=callCash" class="d-flex justify-content-end">
