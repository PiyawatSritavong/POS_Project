	...
	<div class="row">
		...
		<div class="col-3 p-4 bg-secondary text-white">
			...
			<div>
				...
				<div class="d-flex">
					<button onclick="clear_all()" class="btn btn-primary my-2 w-100 m-1">Clear All</button>		
					<button onclick="clear_all()" class="btn btn-primary my-2 w-100 m-1">พักบิล</button>
				</div>
			</div>
		</div>
	</div>	
